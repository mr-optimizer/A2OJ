              ...
              <tr key={problem[0]}>
                ...
                <td className="py-4 px-5 text-gray-900 dark:text-gray-200">
                  <a
                    ...
                    className="hover:ring-2 hover:ring-red-500 dark:hover:ring-offset-transparent focus:ring-2 focus:outline-none rounded px-1 focus:ring-purple-500"
                  >
                    {problem[1]}
                  </a>
                </td>
      ...
      <section>
        <div className="bg-white dark:bg-gray-700 p-6 mx-auto max-w-2xl mb-4 rounded-none sm:rounded-md shadow-sm">
          ...
          <div className="mt-4 h-1 bg-gray-200 dark:bg-gray-600 container rounded-none sm:rounded-full">
            <div
              style={{ width: `${solved}%` }}
              className="h-1 bg-red-500 rounded-none sm:rounded-full"
            ></div>
          </div>
        </div>
