        ...
        <div className="bg-white dark:bg-gray-700 shadow h-auto px-6 py-8 container mx-auto sm:w-8/12 lg:w-6/12 rounded-none sm:rounded-md">
          ...
          <form onSubmit={onSubmit}>
            ...
            <div className="mt-6">
              <button
                type="submit"
                className="w-full focus:outline-none sm:w-auto inline-flex items-center justify-center text-white font-medium leading-none bg-red-500 dark:bg-purple-500 active:bg-purple-700 focus-visible:ring-2 focus-visible:ring-black dark:focus-within:ring-offset-gray-800 focus:ring-offset-2 rounded-lg shadow-sm hover:shadow-lg py-3 px-5 border border-transparent"
              >
                {isSubmitting ? (
                  <>
                    <svg
